...
static int
_route_add(struct poptrie160 *, struct radix_node160 **, XID, int,
           poptrie_leaf_t, int, struct radix_node160 *);
static int _route_add_propagate(struct radix_node160 *, struct radix_node160 *);
static int
_update_part(struct poptrie160 *, struct radix_node160 *, int,
             struct poptrie_stack *, u32 *, int);
static int
_update_subtree(struct poptrie160 *, struct radix_node160 *, XID, int);
static int
_descend_and_update(struct poptrie160 *, struct radix_node160 *, int,
                    struct poptrie_stack *, XID, int, int, u32 *);
static int
_update_inode_chunk(struct poptrie160 *, struct radix_node160 *, int,
                    poptrie_node_t *, poptrie_leaf_t *);
static int
_update_inode_chunk_rec(struct poptrie160 *, struct radix_node160 *, int,
                        poptrie_node_t *, poptrie_leaf_t *, int, int);
static int
_update_inode(struct poptrie160 *, struct radix_node160 *, int, poptrie_node_t *,
              poptrie_leaf_t *);
static int
_update_dp1(struct poptrie160 *, struct radix_node160 *, int, XID, int,
            int);
static int
_update_dp2(struct poptrie160 *, struct radix_node160 *, int, XID, int,
            int);
static void _update_clean_root(struct poptrie160 *, int, int);
static void _update_clean_node(struct poptrie160 *, poptrie_node_t *, int);
static void _update_clean_inode(struct poptrie160 *, int, int);
static void _update_clean_subtree(struct poptrie160 *, int);
...
static int
_route_change(struct poptrie160 *, struct radix_node160 **, XID, int,
              poptrie_leaf_t, int);
static int
_route_update(struct poptrie160 *, struct radix_node160 **, XID, int,
              poptrie_leaf_t, int, struct radix_node160 *);
static int
_route_del(struct poptrie160 *, struct radix_node160 **, XID, int, int,
 ...
 */
struct poptrie160 *
poptrie160_init(struct poptrie160 *poptrie, int sz1, int sz0)
{
    int ret;
    int i;
    ...
    if ( NULL == poptrie ) {
        /* Allocate new one */
        poptrie = malloc(sizeof(struct poptrie160));
        if ( NULL == poptrie ) {
            return NULL;
        }
        (void)memset(poptrie, 0, sizeof(struct poptrie160));
 ...
 */
void
poptrie160_release(struct poptrie160 *poptrie)
{
 ...
 */
int
poptrie160_route_add(struct poptrie160 *poptrie, XID prefix, int len,
                   void *nexthop)
{
    int ret;
    int i;
 ...
 */
int
poptrie160_route_update(struct poptrie160 *poptrie, XID prefix, int len,
                      void *nexthop)
{
    int ret;
    int i;
...
int
poptrie160_route_del(struct poptrie160 *poptrie, XID prefix, int len)
{
 ...
 */
void *
poptrie160_lookup(struct poptrie160 *poptrie, XID addr)
{
    int inode;
    int base;
    int idx;
 ...
 */
void *
poptrie160_rib_lookup(struct poptrie160 *poptrie, XID addr)
{
 ...
 */
static int
_update_part(struct poptrie160 *poptrie, struct radix_node160 *tnode, int inode,
 ...
 */
static int
_update_subtree(struct poptrie160 *poptrie, struct radix_node160 *node,
 ...
 */
static int
_descend_and_update(struct poptrie160 *poptrie, struct radix_node160 *tnode,
 ...
 */
static int
_update_inode_chunk(struct poptrie160 *poptrie, struct radix_node160 *node,
...
static int
_update_inode_chunk_rec(struct poptrie160 *poptrie, struct radix_node160 *node,
                        int inode, poptrie_node_t *nodes, poptrie_leaf_t *leaf,
                        int pos, int r)
{
    int ret;
 ...
 */
static int
_update_inode(struct poptrie160 *poptrie, struct radix_node160 *node, int inode,
 ...
 */
static int
_update_dp1(struct poptrie160 *poptrie, struct radix_node160 *tnode, int alt,
...
static int
_update_dp2(struct poptrie160 *poptrie, struct radix_node160 *tnode, int alt,
            XID prefix, int len, int depth)
{
    int i;
    int idx;
 ...
 */
static void
_update_clean_root(struct poptrie160 *poptrie, int nroot, int oroot)
{
    int i;
    int nn;
    int on;
 ...
 */
static void
_update_clean_node(struct poptrie160 *poptrie, poptrie_node_t *node, int oinode)
{
    int i;
    int n;
...
static void
_update_clean_inode(struct poptrie160 *poptrie, int ninode, int oinode)
{
    int i;
    int obase;
    int nbase;
 ...
 */
static void
_update_clean_subtree(struct poptrie160 *poptrie, int oinode)
{
    int i;
    int n;
    struct poptrie_node *node;
 ...
 */
static int
_route_add(struct poptrie160 *poptrie, struct radix_node160 **node,
           XID prefix, int len, poptrie_leaf_t nexthop, int depth,
           struct radix_node160 *ext)
{
    if ( NULL == *node ) {
        *node = malloc(sizeof(struct radix_node160));
        if ( NULL == *node ) {
            /* Memory error */
            return -1;
        }
...
static int
_route_update(struct poptrie160 *poptrie, struct radix_node160 **node,
              XID prefix, int len, poptrie_leaf_t nexthop, int depth,
              struct radix_node160 *ext)
{
    if ( NULL == *node ) {
...
static int
_route_del(struct poptrie160 *poptrie, struct radix_node160 **node,
